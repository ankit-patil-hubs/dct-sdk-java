...
import com.delphix.dct.models.AlgorithmCreateParameters;
import com.delphix.dct.models.AlgorithmRevision;
import com.delphix.dct.models.AlgorithmRevisionCreateParameters;
import com.delphix.dct.models.CreateAlgorithmResponse;
import com.delphix.dct.models.CreateAlgorithmRevisionResponse;
import com.delphix.dct.models.DeleteAlgorithmResponse;
import com.delphix.dct.models.DeleteAlgorithmRevisionResponse;
...
public class AlgorithmsApi {
     ...
     * @param algorithmCreateParameters The parameters to create an algorithm. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> Algorithm creation initiated </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createAlgorithmCall(AlgorithmCreateParameters algorithmCreateParameters, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = algorithmCreateParameters;
    ...
    private okhttp3.Call createAlgorithmValidateBeforeCall(AlgorithmCreateParameters algorithmCreateParameters, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'algorithmCreateParameters' is set
        if (algorithmCreateParameters == null) {
            throw new ApiException("Missing the required parameter 'algorithmCreateParameters' when calling createAlgorithm(Async)");
        }
        

        okhttp3.Call localVarCall = createAlgorithmCall(algorithmCreateParameters, _callback);
        return localVarCall;
     ...
     */
    public CreateAlgorithmResponse createAlgorithm(AlgorithmCreateParameters algorithmCreateParameters) throws ApiException {
        ApiResponse<CreateAlgorithmResponse> localVarResp = createAlgorithmWithHttpInfo(algorithmCreateParameters);
     ...
     * 
     * @param algorithmCreateParameters The parameters to create an algorithm. (required)
     * @return ApiResponse&lt;CreateAlgorithmResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CreateAlgorithmResponse> createAlgorithmWithHttpInfo(AlgorithmCreateParameters algorithmCreateParameters) throws ApiException {
        okhttp3.Call localVarCall = createAlgorithmValidateBeforeCall(algorithmCreateParameters, null);
        Type localVarReturnType = new TypeToken<CreateAlgorithmResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create a new algorithm. (asynchronously)
     * 
     * @param algorithmCreateParameters The parameters to create an algorithm. (required)
     ...
     */
    public okhttp3.Call createAlgorithmAsync(AlgorithmCreateParameters algorithmCreateParameters, final ApiCallback<CreateAlgorithmResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = createAlgorithmValidateBeforeCall(algorithmCreateParameters, _callback);
        Type localVarReturnType = new TypeToken<CreateAlgorithmResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for createAlgorithmRevision
     * @param algorithmId The ID of the Algorithm. (required)
     * @param algorithmRevisionCreateParameters The parameters to create an algorithm revision. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Algorithm creation revision initiated </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createAlgorithmRevisionCall(String algorithmId, AlgorithmRevisionCreateParameters algorithmRevisionCreateParameters, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = algorithmRevisionCreateParameters;

        // create path and map variables
        String localVarPath = "/algorithms/{algorithmId}/revisions"
            .replaceAll("\\{" + "algorithmId" + "\\}", localVarApiClient.escapeString(algorithmId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createAlgorithmRevisionValidateBeforeCall(String algorithmId, AlgorithmRevisionCreateParameters algorithmRevisionCreateParameters, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'algorithmId' is set
        if (algorithmId == null) {
            throw new ApiException("Missing the required parameter 'algorithmId' when calling createAlgorithmRevision(Async)");
        }
        
        // verify the required parameter 'algorithmRevisionCreateParameters' is set
        if (algorithmRevisionCreateParameters == null) {
            throw new ApiException("Missing the required parameter 'algorithmRevisionCreateParameters' when calling createAlgorithmRevision(Async)");
        }
        

        okhttp3.Call localVarCall = createAlgorithmRevisionCall(algorithmId, algorithmRevisionCreateParameters, _callback);
        return localVarCall;
     ...
     */
    public CreateAlgorithmRevisionResponse createAlgorithmRevision(String algorithmId, AlgorithmRevisionCreateParameters algorithmRevisionCreateParameters) throws ApiException {
        ApiResponse<CreateAlgorithmRevisionResponse> localVarResp = createAlgorithmRevisionWithHttpInfo(algorithmId, algorithmRevisionCreateParameters);
        return localVarResp.getData();
    }
     ...
     * @param algorithmId The ID of the Algorithm. (required)
     * @param algorithmRevisionCreateParameters The parameters to create an algorithm revision. (required)
     * @return ApiResponse&lt;CreateAlgorithmRevisionResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CreateAlgorithmRevisionResponse> createAlgorithmRevisionWithHttpInfo(String algorithmId, AlgorithmRevisionCreateParameters algorithmRevisionCreateParameters) throws ApiException {
        okhttp3.Call localVarCall = createAlgorithmRevisionValidateBeforeCall(algorithmId, algorithmRevisionCreateParameters, null);
        Type localVarReturnType = new TypeToken<CreateAlgorithmRevisionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create a new algorithm revision. (asynchronously)
     * 
     * @param algorithmId The ID of the Algorithm. (required)
     * @param algorithmRevisionCreateParameters The parameters to create an algorithm revision. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createAlgorithmRevisionAsync(String algorithmId, AlgorithmRevisionCreateParameters algorithmRevisionCreateParameters, final ApiCallback<CreateAlgorithmRevisionResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = createAlgorithmRevisionValidateBeforeCall(algorithmId, algorithmRevisionCreateParameters, _callback);
        Type localVarReturnType = new TypeToken<CreateAlgorithmRevisionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call createAlgorithmRevisionTagsValidateBeforeCall(String algorithmId, String revisionId, TagsRequest tagsRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createAlgorithmRevisionTagsCall(algorithmId, revisionId, tagsRequest, _callback);
        return localVarCall;
    ...
    private okhttp3.Call createAlgorithmTagsValidateBeforeCall(String algorithmId, TagsRequest tagsRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createAlgorithmTagsCall(algorithmId, tagsRequest, _callback);
        return localVarCall;
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Algorithm delete initiated. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteAlgorithmCall(String algorithmId, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteAlgorithmValidateBeforeCall(String algorithmId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'algorithmId' is set
        if (algorithmId == null) {
            throw new ApiException("Missing the required parameter 'algorithmId' when calling deleteAlgorithm(Async)");
        }
        

        okhttp3.Call localVarCall = deleteAlgorithmCall(algorithmId, _callback);
        return localVarCall;
     ...
     */
    public DeleteAlgorithmResponse deleteAlgorithm(String algorithmId) throws ApiException {
        ApiResponse<DeleteAlgorithmResponse> localVarResp = deleteAlgorithmWithHttpInfo(algorithmId);
        return localVarResp.getData();
    }
     ...
     * 
     * @param algorithmId The ID of the Algorithm. (required)
     * @return ApiResponse&lt;DeleteAlgorithmResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<DeleteAlgorithmResponse> deleteAlgorithmWithHttpInfo(String algorithmId) throws ApiException {
        okhttp3.Call localVarCall = deleteAlgorithmValidateBeforeCall(algorithmId, null);
        Type localVarReturnType = new TypeToken<DeleteAlgorithmResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Delete an algorithm. (asynchronously)
     * 
     * @param algorithmId The ID of the Algorithm. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteAlgorithmAsync(String algorithmId, final ApiCallback<DeleteAlgorithmResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteAlgorithmValidateBeforeCall(algorithmId, _callback);
        Type localVarReturnType = new TypeToken<DeleteAlgorithmResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteAlgorithmRevision
     * @param algorithmId The ID of the Algorithm. (required)
     * @param revisionId The ID of the Algorithm revision. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Algorithm revision delete initiated. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteAlgorithmRevisionCall(String algorithmId, String revisionId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteAlgorithmRevisionValidateBeforeCall(String algorithmId, String revisionId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'algorithmId' is set
        if (algorithmId == null) {
            throw new ApiException("Missing the required parameter 'algorithmId' when calling deleteAlgorithmRevision(Async)");
        }
        
        // verify the required parameter 'revisionId' is set
        if (revisionId == null) {
            throw new ApiException("Missing the required parameter 'revisionId' when calling deleteAlgorithmRevision(Async)");
        }
        

        okhttp3.Call localVarCall = deleteAlgorithmRevisionCall(algorithmId, revisionId, _callback);
        return localVarCall;
     ...
     */
    public DeleteAlgorithmRevisionResponse deleteAlgorithmRevision(String algorithmId, String revisionId) throws ApiException {
        ApiResponse<DeleteAlgorithmRevisionResponse> localVarResp = deleteAlgorithmRevisionWithHttpInfo(algorithmId, revisionId);
        return localVarResp.getData();
    }
     ...
     * @param algorithmId The ID of the Algorithm. (required)
     * @param revisionId The ID of the Algorithm revision. (required)
     * @return ApiResponse&lt;DeleteAlgorithmRevisionResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<DeleteAlgorithmRevisionResponse> deleteAlgorithmRevisionWithHttpInfo(String algorithmId, String revisionId) throws ApiException {
        okhttp3.Call localVarCall = deleteAlgorithmRevisionValidateBeforeCall(algorithmId, revisionId, null);
        Type localVarReturnType = new TypeToken<DeleteAlgorithmRevisionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Delete an algorithm revision. (asynchronously)
     * 
     * @param algorithmId The ID of the Algorithm. (required)
     * @param revisionId The ID of the Algorithm revision. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call deleteAlgorithmRevisionAsync(String algorithmId, String revisionId, final ApiCallback<DeleteAlgorithmRevisionResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteAlgorithmRevisionValidateBeforeCall(algorithmId, revisionId, _callback);
        Type localVarReturnType = new TypeToken<DeleteAlgorithmRevisionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call deleteAlgorithmRevisionTagsValidateBeforeCall(String algorithmId, String revisionId, DeleteTag deleteTag, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteAlgorithmRevisionTagsCall(algorithmId, revisionId, deleteTag, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteAlgorithmTagsValidateBeforeCall(String algorithmId, DeleteTag deleteTag, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteAlgorithmTagsCall(algorithmId, deleteTag, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAlgorithmByIdValidateBeforeCall(String algorithmId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAlgorithmByIdCall(algorithmId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAlgorithmRevisionByIdValidateBeforeCall(String algorithmId, String revisionId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAlgorithmRevisionByIdCall(algorithmId, revisionId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAlgorithmRevisionTagsValidateBeforeCall(String algorithmId, String revisionId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAlgorithmRevisionTagsCall(algorithmId, revisionId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAlgorithmRevisionsValidateBeforeCall(String algorithmId, Integer limit, String cursor, String sort, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAlgorithmRevisionsCall(algorithmId, limit, cursor, sort, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAlgorithmTagsValidateBeforeCall(String algorithmId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAlgorithmTagsCall(algorithmId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAlgorithmsValidateBeforeCall(Integer limit, String cursor, String sort, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAlgorithmsCall(limit, cursor, sort, _callback);
        return localVarCall;
    ...
    private okhttp3.Call searchAlgorithmRevisionsValidateBeforeCall(String algorithmId, Integer limit, String cursor, String sort, SearchBody searchBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = searchAlgorithmRevisionsCall(algorithmId, limit, cursor, sort, searchBody, _callback);
        return localVarCall;
    ...
    private okhttp3.Call searchAlgorithmsValidateBeforeCall(Integer limit, String cursor, String sort, SearchBody searchBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = searchAlgorithmsCall(limit, cursor, sort, searchBody, _callback);
        return localVarCall;
    ...
    private okhttp3.Call setAlgorithmPrimaryRevisionValidateBeforeCall(String algorithmId, String revisionId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setAlgorithmPrimaryRevisionCall(algorithmId, revisionId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call updateAlgorithmRevisionValidateBeforeCall(String algorithmId, String revisionId, UpdateAlgorithmRevisionParameters updateAlgorithmRevisionParameters, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateAlgorithmRevisionCall(algorithmId, revisionId, updateAlgorithmRevisionParameters, _callback);
        return localVarCall;
