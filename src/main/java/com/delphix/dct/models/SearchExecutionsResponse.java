...
public class SearchExecutionsResponse {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<Execution> items = null;
  ...
  public SearchExecutionsResponse items(List<Execution> items) {
    
    this.items = items;
    return this;
  }

  public SearchExecutionsResponse addItemsItem(Execution itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Execution>();
    }
  ...
  **/
  ...
  public SearchExecutionsResponse responseMetadata(PaginatedResponseMetadata responseMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SearchExecutionsResponse searchExecutionsResponse = (SearchExecutionsResponse) o;
    return Objects.equals(this.items, searchExecutionsResponse.items) &&
        Objects.equals(this.responseMetadata, searchExecutionsResponse.responseMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchExecutionsResponse {\n");
