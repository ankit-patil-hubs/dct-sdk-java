...
public class SearchAccountsResponse {
  ...
  public SearchAccountsResponse items(List<Account> items) {
    
    this.items = items;
    return this;
  }

  public SearchAccountsResponse addItemsItem(Account itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public SearchAccountsResponse responseMetadata(PaginatedResponseMetadata responseMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SearchAccountsResponse searchAccountsResponse = (SearchAccountsResponse) o;
    return Objects.equals(this.items, searchAccountsResponse.items) &&
        Objects.equals(this.responseMetadata, searchAccountsResponse.responseMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchAccountsResponse {\n");
