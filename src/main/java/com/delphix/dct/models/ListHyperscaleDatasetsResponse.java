...
public class ListHyperscaleDatasetsResponse {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<HyperscaleDataset> items = null;
  ...
  public ListHyperscaleDatasetsResponse items(List<HyperscaleDataset> items) {
    
    this.items = items;
    return this;
  }

  public ListHyperscaleDatasetsResponse addItemsItem(HyperscaleDataset itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<HyperscaleDataset>();
    }
  ...
  **/
  ...
  public ListHyperscaleDatasetsResponse responseMetadata(PaginatedResponseMetadata responseMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ListHyperscaleDatasetsResponse listHyperscaleDatasetsResponse = (ListHyperscaleDatasetsResponse) o;
    return Objects.equals(this.items, listHyperscaleDatasetsResponse.items) &&
        Objects.equals(this.responseMetadata, listHyperscaleDatasetsResponse.responseMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListHyperscaleDatasetsResponse {\n");
