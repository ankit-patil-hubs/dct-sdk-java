...
public class SearchMaskingJobsResponse {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<MaskingJob> items = null;
  ...
  public SearchMaskingJobsResponse items(List<MaskingJob> items) {
    
    this.items = items;
    return this;
  }

  public SearchMaskingJobsResponse addItemsItem(MaskingJob itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<MaskingJob>();
    }
  ...
  **/
  ...
  public List<MaskingJob> getItems() {
    return items;
  }


  public void setItems(List<MaskingJob> items) {
    this.items = items;
  }


  public SearchMaskingJobsResponse responseMetadata(PaginatedResponseMetadata responseMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SearchMaskingJobsResponse searchMaskingJobsResponse = (SearchMaskingJobsResponse) o;
    return Objects.equals(this.items, searchMaskingJobsResponse.items) &&
        Objects.equals(this.responseMetadata, searchMaskingJobsResponse.responseMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchMaskingJobsResponse {\n");
