...
public class SearchRolesResponse {
  ...
  public SearchRolesResponse items(List<Role> items) {
    
    this.items = items;
    return this;
  }

  public SearchRolesResponse addItemsItem(Role itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public SearchRolesResponse responseMetadata(PaginatedResponseMetadata responseMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SearchRolesResponse searchRolesResponse = (SearchRolesResponse) o;
    return Objects.equals(this.items, searchRolesResponse.items) &&
        Objects.equals(this.responseMetadata, searchRolesResponse.responseMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchRolesResponse {\n");
