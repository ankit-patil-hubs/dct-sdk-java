...
public class SearchAlgorithmsResponse {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<Algorithm> items = null;
  ...
  public SearchAlgorithmsResponse items(List<Algorithm> items) {
    
    this.items = items;
    return this;
  }

  public SearchAlgorithmsResponse addItemsItem(Algorithm itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Algorithm>();
    }
  ...
  **/
  ...
  public List<Algorithm> getItems() {
    return items;
  }


  public void setItems(List<Algorithm> items) {
    this.items = items;
  }


  public SearchAlgorithmsResponse responseMetadata(PaginatedResponseMetadata responseMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SearchAlgorithmsResponse searchAlgorithmsResponse = (SearchAlgorithmsResponse) o;
    return Objects.equals(this.items, searchAlgorithmsResponse.items) &&
        Objects.equals(this.responseMetadata, searchAlgorithmsResponse.responseMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchAlgorithmsResponse {\n");
