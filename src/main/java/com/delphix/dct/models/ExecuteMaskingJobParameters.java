 ...
 */
@ApiModel(description = "Parameters to execute a MaskingJob.")
...
public class ExecuteMaskingJobParameters {
  ...
  **/
  ...
  @ApiModelProperty(example = "engine-123", value = "The ID of the Engine to execute this MaskingJob on (Standard job only).")
