...
public class SearchHyperscaleMountPointsResponse {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<HyperscaleMountPoint> items = null;
  ...
  public SearchHyperscaleMountPointsResponse items(List<HyperscaleMountPoint> items) {
    
    this.items = items;
    return this;
  }

  public SearchHyperscaleMountPointsResponse addItemsItem(HyperscaleMountPoint itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<HyperscaleMountPoint>();
    }
  ...
  **/
  ...
  public SearchHyperscaleMountPointsResponse responseMetadata(PaginatedResponseMetadata responseMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SearchHyperscaleMountPointsResponse searchHyperscaleMountPointsResponse = (SearchHyperscaleMountPointsResponse) o;
    return Objects.equals(this.items, searchHyperscaleMountPointsResponse.items) &&
        Objects.equals(this.responseMetadata, searchHyperscaleMountPointsResponse.responseMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchHyperscaleMountPointsResponse {\n");
