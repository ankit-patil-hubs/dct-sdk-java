 ...
 */
@ApiModel(description = "A table or file which is part of a hyperscale dataset.")
...
public class HyperscaleDatasetTableOrFile {
  ...
  private List<HyperscaleColumnOrField> maskingInventory = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the Hyperscale Dataset table or file.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the table schema (Oracle/MSSql only).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the table (Oracle/MSSql only).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the collection (MongoDB only).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the database (MongoDB only).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique database column field to filter the source data.")
  ...
  **/
  ...
  public HyperscaleDatasetTableOrFile addMaskingInventoryItem(HyperscaleColumnOrField maskingInventoryItem) {
    if (this.maskingInventory == null) {
      this.maskingInventory = new ArrayList<HyperscaleColumnOrField>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "DataSet information for masking inventory.")
