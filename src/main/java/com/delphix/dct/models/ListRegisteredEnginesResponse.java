...
public class ListRegisteredEnginesResponse {
  ...
  public ListRegisteredEnginesResponse items(List<RegisteredEngine> items) {
    
    this.items = items;
    return this;
  }

  public ListRegisteredEnginesResponse addItemsItem(RegisteredEngine itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public ListRegisteredEnginesResponse responseMetadata(PaginatedResponseMetadata responseMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ListRegisteredEnginesResponse listRegisteredEnginesResponse = (ListRegisteredEnginesResponse) o;
    return Objects.equals(this.items, listRegisteredEnginesResponse.items) &&
        Objects.equals(this.responseMetadata, listRegisteredEnginesResponse.responseMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListRegisteredEnginesResponse {\n");
