 ...
 */
@ApiModel(description = "The product history data included in the phonehome bundle's product information.")
...
public class PhoneHomeBundleProductHistory {
  ...
  **/
  ...
  @ApiModelProperty(example = "15.0.0", required = true, value = "The product version.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2024-03-05T17:17:39.512532Z", required = true, value = "The UTC time when the version was installed (ISO 8601 format)")
