...
public class RegisteredEngine {
  ...
  private List<String> hyperscaleInstanceIds = null;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Allow connections to the engine over HTTPs without validating the TLS certificate. Even though the connection to the engine might be performed over HTTPs, setting this property eliminates the protection against a man-in-the-middle attach for connections to this engine. Instead, consider creating a truststore with a Certificate Authority to validate the engine's certificate, and set the truststore_filename property. ")
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the connection to the engine. Deprecated; use \"engine_connection_status\" instead.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The state of the connection to the engine.")
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If set, details about the status of the connection to the engine. Deprecated; use \"engine_connection_status_details\" instead.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If set, details about the state of the connection to the engine.")
  ...
  **/
  ...
  public RegisteredEngine addHyperscaleInstanceIdsItem(String hyperscaleInstanceIdsItem) {
    if (this.hyperscaleInstanceIds == null) {
      this.hyperscaleInstanceIds = new ArrayList<String>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of Hyperscale Instances that this engine is connected to.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "File name of a truststore which can be used to validate the TLS certificate of the engine as expected by associated hyperscale instances. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Password to read the truststore as expected by associated hyperscale instances. ")
