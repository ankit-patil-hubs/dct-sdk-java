 ...
 */
@ApiModel(description = "A masking job's source engine.")
...
public class MaskingJobSourceEngine {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "engine-123", value = "The ID of the Engine serving as the source for the MaskingJob.")
