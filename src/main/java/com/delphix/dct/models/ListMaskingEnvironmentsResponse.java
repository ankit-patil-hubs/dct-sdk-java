...
public class ListMaskingEnvironmentsResponse {
  ...
  public ListMaskingEnvironmentsResponse items(List<MaskingEnvironment> items) {
    
    this.items = items;
    return this;
  }

  public ListMaskingEnvironmentsResponse addItemsItem(MaskingEnvironment itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public ListMaskingEnvironmentsResponse responseMetadata(PaginatedResponseMetadata responseMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ListMaskingEnvironmentsResponse listMaskingEnvironmentsResponse = (ListMaskingEnvironmentsResponse) o;
    return Objects.equals(this.items, listMaskingEnvironmentsResponse.items) &&
        Objects.equals(this.responseMetadata, listMaskingEnvironmentsResponse.responseMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMaskingEnvironmentsResponse {\n");
