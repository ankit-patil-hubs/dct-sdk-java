...
public class SearchJobsResponse {
  ...
  public SearchJobsResponse items(List<Job> items) {
    
    this.items = items;
    return this;
  }

  public SearchJobsResponse addItemsItem(Job itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Job>();
    }
  ...
  **/
  ...
  public SearchJobsResponse responseMetadata(PaginatedResponseMetadata responseMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, searchJobsResponse.items) &&
        Objects.equals(this.responseMetadata, searchJobsResponse.responseMetadata);
  }
