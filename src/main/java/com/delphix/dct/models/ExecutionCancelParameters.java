...
public class ExecutionCancelParameters {
  ...
  **/
  ...
  @ApiModelProperty(example = "QUEUED", value = "The expected status of the execution to cancel to prevent cancelling a queued job that has transitioned to a running state since the request was issued (Standard Job only).")
