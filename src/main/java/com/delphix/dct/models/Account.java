...
public class Account {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "last time this account made a (successful or failed) API call. Note that updates to this property are asynchronous and make take some time to be reflected.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Creation time of this Account. This value is null for accounts created prior to version 9.0.0 of the product.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether this account can be used to make API calls.")
