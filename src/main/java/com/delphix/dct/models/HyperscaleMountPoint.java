 ...
 */
@ApiModel(description = "A Mount Point for the Hyperscale instance to write to a staging area and engines to read from.")
...
public class HyperscaleMountPoint {
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the Hyperscale Mount Point.")
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The ID of the Hyperscale instance of this Mount Point.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Name of the mount, unique for a hyperscale instance. This name will be used as a directory name by the Hyperscale instance.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The host name of the server.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The path to the directory on the filesystem to mount.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The type of filesystem. Enum having values- CIFS, NFS3, NFS4.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The options for mount. The endpoint will return all default options and user specified options.")
